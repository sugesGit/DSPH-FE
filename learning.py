...
print("随机森林准确率="+str(acc0))
print("随机森林精确率="+str(p0))
print("随机森林召回率="+str(call0))
print("随机森林F指标="+str(F_0))
print('time='+str(end-start))
#np.savetxt("statistic vedio/随机森林correct_vedio_code2.csv",correct_vedio_code)
#np.savetxt("statistic vedio/随机森林wrong_vedio_code2.csv",wrong_vedio_code)
...
# F_0=2*p0*call0/(p0+call0)
# end = time.time()
# print("决策树准确率="+str(acc0))
# print("决策树精确率="+str(p0))
# print("决策树召回率="+str(call0))
# print("决策树F指标="+str(F_0))
# print('time='+str(end-start))
# #np.savetxt("statistic vedio/决策树correct_vedio_code2.csv",correct_vedio_code)
# #np.savetxt("statistic vedio/决策树wrong_vedio_code2.csv",wrong_vedio_code)
...
# F_0=2*p0*call0/(p0+call0)
# end = time.time()
# print("贝叶斯准确率="+str(acc0))
# print("贝叶斯精确率="+str(p0))
# print("贝叶斯召回率="+str(call0))
# print("贝叶斯F指标="+str(F_0))
# print('time='+str(end-start))
# #np.savetxt("statistic vedio/贝叶斯correct_vedio_code2.csv",correct_vedio_code)
# #np.savetxt("statistic vedio/贝叶斯wrong_vedio_code2.csv",wrong_vedio_code)
...
# F_0=2*p0*call0/(p0+call0)
# end = time.time()
# print("SVM准确率="+str(acc0))
# print("贝叶斯精确率="+str(p0))
# print("SVM召回率="+str(call0))
# print("SVMF指标="+str(F_0))
# print('time='+str(end-start))
...
# F_0=2*p0*call0/(p0+call0)
# end = time.time()
# print("KNN准确率="+str(acc0))
# print("贝叶斯精确率="+str(p0))
# print("KNN召回率="+str(call0))
# print("KNNF指标="+str(F_0))
# print('time='+str(end-start))
